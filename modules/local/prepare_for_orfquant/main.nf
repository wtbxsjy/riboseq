...
process PREPARE_FOR_ORFQUANT_CORRECTED {
    ...
    // Supports both old (orfquant_container) and new (orfquant_mirai_container) param names
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        (params.orfquant_mirai_container ?: params.orfquant_container ?: 'https://depot.galaxyproject.org/singularity/riboseqc:1.1--r36_1') :
